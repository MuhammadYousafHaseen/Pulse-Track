    ...
    <header className="sticky top-0 z-30 border-b border-cyan-500/10 bg-[#020617]/80 backdrop-blur-xl">
      ...
      <div className="flex items-center justify-between px-4 py-4 md:px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={onMenuClick}
            className="rounded-xl border border-cyan-500/20 bg-white/5 p-2 text-white lg:hidden"
          >
            <Menu size={22} />
          </button>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="relative rounded-2xl border border-cyan-500/10 bg-white/5 p-3">
